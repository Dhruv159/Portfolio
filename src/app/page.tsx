                ...
                <div className="container flex h-16 items-center justify-between">
                    ...
                    <div className="flex items-center gap-4">
                        <nav className="hidden md:flex gap-6">
                            <Link href="#about" className="group relative text-sm font-medium transition-colors hover:text-primary">
                                About
                                <span className="absolute inset-x-0 -bottom-1 h-0.5 scale-x-0 bg-primary transition-transform group-hover:scale-x-100"></span>
                            </Link>
                            <Link
                                href="#projects"
                            ...
                            <Link href="#skills" className="group relative text-sm font-medium transition-colors hover:text-primary">
                                Skills
                                <span className="absolute inset-x-0 -bottom-1 h-0.5 scale-x-0 bg-primary transition-transform group-hover:scale-x-100"></span>
                            </Link>
                            <Link href="#contact" className="group relative text-sm font-medium transition-colors hover:text-primary">
                                Contact
                                <span className="absolute inset-x-0 -bottom-1 h-0.5 scale-x-0 bg-primary transition-transform group-hover:scale-x-100"></span>
                            </Link>
                        </nav>
                    ...
                    <div className="container px-4 md:px-6">
                        <div className="grid gap-6 lg:grid-cols-[1fr_400px] lg:gap-12 xl:grid-cols-[1fr_600px]">
                            ...
                            <div className="relative mx-auto lg:order-last">
                                <div className="absolute -inset-1 rounded-xl bg-gradient-to-r from-primary/50 to-primary blur-md dark:from-primary/30 dark:to-primary/50"></div>
                                <Image src="/dhruv-image.jpg"
                                        width={450}
                                        height={450}
                                        alt="Image"
